...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        H_prime = int(1 + (input_dim[1] + 2 * 0 - 2) / 2)
        W_prime = int(1 + (input_dim[2] + 2 * 0 - 2) / 2)

        self.params['W1'] = np.random.normal(loc=0,scale=weight_scale,size=(num_filters, input_dim[0], filter_size, filter_size))
        self.params['W2'] = np.random.normal(loc= 0 ,scale= weight_scale,size =((H_prime * W_prime * num_filters), hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        dx, grads['W3'], grads['b3'] = affine_backward(dout, cache_3)
